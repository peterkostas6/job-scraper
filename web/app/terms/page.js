  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "48px 24px 80px", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", color: "#1e293b" }}>
      ...
      <section style={{ marginBottom: 36 }}>
        ...
        <p style={{ fontSize: 15, color: "#334155", lineHeight: 1.7 }}>Pete's Postings aggregates publicly available job listings from financial institutions and displays them in a single interface. Browsing current listings is free. A paid Pro subscription adds text and email job alerts, the recent postings feed, saved jobs, and company requests. Links to job postings pass through petespostings.com before sending you to the employer's site.</p>
      </section>
      ...
      <section style={{ marginBottom: 36 }}>
        ...
        <ul style={{ fontSize: 15, color: "#334155", lineHeight: 2, paddingLeft: 20, marginBottom: 12 }}>
          ...
          <li><strong>Price changes:</strong> we will tell you before a price change affects your subscription, and you can cancel before it takes effect.</li>
        </ul>
        <p style={{ fontSize: 15, color: "#334155", lineHeight: 1.7 }}>Students at partner schools may receive Pro access at no charge; that access can end if the partnership ends.</p>
      </section>

      <section style={{ marginBottom: 36 }}>
        <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 12 }}>4. SMS Notifications</h2>
        <p style={{ fontSize: 15, color: "#334155", lineHeight: 1.7, marginBottom: 12 }}>By enabling SMS notifications in your account dashboard, you consent to receive recurring automated text messages from Pete's Postings about new job postings matching your preferences. Consent is not a condition of any purchase.</p>
        <ul style={{ fontSize: 15, color: "#334155", lineHeight: 2, paddingLeft: 20 }}>
          ...
          <li>Alert texts contain short links to each job; we record when a link is tapped.</li>
          <li>Carriers are not liable for delayed or undelivered messages.</li>
          <li>Your phone number and SMS opt-in consent are never shared with third parties or affiliates for marketing purposes.</li>
        </ul>
      </section>
